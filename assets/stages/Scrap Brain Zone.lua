...
if not lowQuality then
		...
		makeAnimatedLuaSprite('edi', 'stage/Scrap brain zone 1',-500, -400);
		...
		makeAnimatedLuaSprite('suelo', 'stage/Scrap brain zone 3',-600, -592);
	...
	addAnimationByPrefix('edi', 'idle', 'Scrap brain zone 1 idle', 10, true);
	addLuaSprite('edi 2', false); 
	addAnimationByPrefix('edi 2', 'idle', 'Scrap brain zone 2 idle', 2, true);
	addLuaSprite('suelo', false);
	addAnimationByPrefix('suelo', 'idle', 'Scrap brain zone 3 idle', 5, true);
